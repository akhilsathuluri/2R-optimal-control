...
axisToRotMat[{k1_, k2_, k3_}, \[Phi]_]:=
	...
	k1s = k1/Sqrt[k1^2+k2^2+k3^2];
	k2s = k2/Sqrt[k1^2+k2^2+k3^2];
	k3s = k3/Sqrt[k1^2+k2^2+k3^2];
	K = {{0, k3s, -k2s}, {-k3s, 0, k1s},{k2s, -k1s, 0}};
	(*K = {{0, k3, -k2}, {-k3, 0, k1},{k2, -k1, 0}};*)
	Iden = {{1,0,0},{0,1,0},{0,0,1}};	
	Rk\[Phi] = Iden+K*Sin[\[Phi]]+K^2*(1-Cos[\[Phi]]);
	Return[Rk\[Phi]];
	];
...
If[x^2+y^2-d3^2<0\[Or]d4^2+a3^2-K^2<0,Print[StringForm["Singularity due to construction of the manipulator"]],
...
If[a2^2+a3^2+d4^2+2*a2*(a3*Cos[\[Theta]3[[1]]]-d4*Sin[\[Theta]3[[1]]])<0||a2^2+a3^2+d4^2+2*a2*(a3*Cos[\[Theta]3[[2]]]-d4*Sin[\[Theta]3[[2]]])<0,Print[StringForm["Singular position!"]],
